📦
442458 /gojni_baseline_agent.js
274557 /gojni_baseline_agent.js.map
✄
...
// gojni_baseline_agent.ts
rpc.exports.run = function(sourceBase64) {
  return new Promise(function(resolve, reject) {
    frida_java_bridge_default.perform(function() {
      try {
        const Base64 = frida_java_bridge_default.use("android.util.Base64");
        const BitmapFactory = frida_java_bridge_default.use("android.graphics.BitmapFactory");
        const Bitmap = frida_java_bridge_default.use("android.graphics.Bitmap");
        const CompressFormat = frida_java_bridge_default.use("android.graphics.Bitmap$CompressFormat");
        const Matrix = frida_java_bridge_default.use("android.graphics.Matrix");
        ...
        const ExifInterface = frida_java_bridge_default.use("android.media.ExifInterface");
        const Resizer = frida_java_bridge_default.use("resizer.Resizer");
        ...
        if (bitmap === null)
          throw new Error("BitmapFactory.decodeByteArray failed");
        let degrees = 0;
        if (orientation === 3)
          degrees = 180;
